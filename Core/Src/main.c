...
const osThreadAttr_t BrainComTask_attributes = {
  .name = "BrainComTask",
  .stack_size = 128 * 4,
...
const osThreadAttr_t DebugComTask_attributes = {
  .name = "DebugComTask",
  .stack_size = 128 * 4,
...
const osThreadAttr_t UsbComTask_attributes = {
  .name = "UsbComTask",
  .stack_size = 128 * 4,
...
const osMessageQueueAttr_t GoalPositionQueue_attributes = {
  .name = "GoalPositionQueue"
};
/* Definitions for GoalSpeedQueue */
osMessageQueueId_t GoalSpeedQueueHandle;
const osMessageQueueAttr_t GoalSpeedQueue_attributes = {
  .name = "GoalSpeedQueue"
};
/* Definitions for OdometryQueue */
osMessageQueueId_t OdometryQueueHandle;
const osMessageQueueAttr_t OdometryQueue_attributes = {
  .name = "OdometryQueue"
};
/* Definitions for EncoderTask */
osTimerId_t EncoderTaskHandle;
const osTimerAttr_t EncoderTask_attributes = {
  .name = "EncoderTask"
};
/* Definitions for MotorTask */
osTimerId_t MotorTaskHandle;
const osTimerAttr_t MotorTask_attributes = {
  .name = "MotorTask"
};
/* Definitions for debugEvent */
osEventFlagsId_t debugEventHandle;
const osEventFlagsAttr_t debugEvent_attributes = {
  .name = "debugEvent"
};
...
int main(void)
{
  ...
  EncoderTaskHandle = osTimerNew(EncoderTaskCallback, osTimerPeriodic, NULL, &EncoderTask_attributes);
  ...
  GoalPositionQueueHandle = osMessageQueueNew (16, sizeof(poseStruct), &GoalPositionQueue_attributes);

  /* creation of GoalSpeedQueue */
  GoalSpeedQueueHandle = osMessageQueueNew (16, sizeof(velocityStruct), &GoalSpeedQueue_attributes);
